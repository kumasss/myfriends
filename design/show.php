...
<?php //INSERT INTO `friends`(`freind_id`, `friend_name`, `area_id`, `gender`, `age`, `created`, `modified`) VALUES ("","1","1","3","now()")
...
//５.都道府県名を取得
$area=$stmt->fetch(POD::FETCH_ASSOC);
...
<html lang="ja">
  ...
  <div class="container">
    <div class="row">
      ...
      <legend><?php echo $area_name['area_name']; ?></legend>
